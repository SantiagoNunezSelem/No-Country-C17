    ...
    <div id="seleccionar-personal">
      <section className="flex flex-row w-9/12 h-5/6 m-auto mt-4 mb-2">
        <div className="w-4/6 max-h-96 border-2 p-10 pt-7 mr-5 rounded-xl">
          ...
          <div
            id="profesional-container"
            className="max-h-72 overflow-y-scroll"
          >
            <div
              id="primerProfesional"
              className="flex flex-row gap-5 border-2 mb-2 p-2 rounded-xl seleccionado"
              onClick={() => handleClick("primerProfesional")}
            >
              <Image
                  ...
                  <div className="self-center">
                    {reserva && reserva.length > 1 && (
                      <Image
                        ...
                        onClick={() => borrarServicio(p.title)}
                      />
                    )}
                  </div>
                </div>
